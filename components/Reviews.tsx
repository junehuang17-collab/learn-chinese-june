...
export default function Reviews() {
  return (
    <div className="review-grid review-masonry">
      {reviews.map((review) => (
        <blockquote className="review-card" key={`${review.name}-${review.date}`}>
          <div className="review-profile">
            <div className="review-avatar-wrap">
              {review.avatar ? (
                ...
                <span className={`review-avatar review-avatar-initial review-avatar-${review.avatarTone ?? "green"}`} aria-hidden="true">{review.initial}</span>
              )}
          ...
          <p>“{review.quote}”</p>
          <footer className="review-date"><time>{review.date}</time></footer>
        </blockquote>
      ))}
    </div>
  );
