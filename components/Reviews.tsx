          ...
          <div className="review-profile">
            <div className="review-avatar-wrap">
              {review.avatar ? (
                ...
                <span className={`review-avatar review-avatar-initial review-avatar-${review.avatarTone ?? "teal"}`} aria-hidden="true">{review.initial}</span>
              )}
            ...
            <span className="review-pin" aria-hidden="true">⌖</span>
          </div>
